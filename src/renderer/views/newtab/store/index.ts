...
export class Store {
  ...
  public set newsBehavior(value: NewsBehavior) {
    ...
    console.log(this._newsBehavior);
    if(this._newsBehavior == false){
  ...
  public async loadImage() {
    ...
    fetch(url)
      ...
      .catch((e) => {
        localStorage.setItem('imageURL', 'D:/Windows/Web/Wallpaper/Windows/img0.jpg');
      });
  }
  ...
  public async loadTopSites() {
    this.topSites = await (window as any).getTopSites(16);
  }
}
